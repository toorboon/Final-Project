...
CREATE TABLE `course_exercises` (
  ...
  KEY `fk_course_exercises_2_idx` (`exercise_type_id`),
  ...
  CONSTRAINT `fk_course_exercises_2` FOREIGN KEY (`exercise_type_id`) REFERENCES `exercise_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-12-07 16:14:01
