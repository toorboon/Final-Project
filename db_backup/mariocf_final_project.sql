...
--
-- Host: localhost:3306
-- Erstellungszeit: 10. Dez 2018 um 23:15
...
--
-- Tabellenstruktur für Tabelle `available_students`
--

CREATE TABLE `available_students` (
  `array_pos` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `de_id` int(11) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `available_students`
--

INSERT INTO `available_students` (`array_pos`, `user_id`, `de_id`) VALUES
(0, 1, NULL),
(1, 2, NULL),
(2, 3, NULL),
(3, 4, NULL),
...
--
ALTER TABLE `pair_partner`
  ADD CONSTRAINT `fk_pair_partner_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
